...
# Tools without langchain @tool deocorator
...
def apply_discount(price:float, discount_tier: str) -> float:
    """Apply a discount tier to a price and return the price.
    Available tiers: bronze, silver, gold"""
    print(f"    >> Executing apply_discount(price:'{price}',discount_tier:'{discount_tier}')")
    disocunt_percentages = {"bronze": 5, "silver":12, "gold":23}
    discount= disocunt_percentages.get(discount_tier,0)
...
if __name__ == "__main__":
    print("Helo langchain agent (.bind_tools)")
    print()
